  ...
  return (
    <div className="min-h-screen bg-[#0a0b0f] text-white font-display flex items-center justify-center p-6">
      <div className="absolute inset-0 opacity-40 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(236,91,19,0.15),transparent_45%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(37,99,235,0.12),transparent_40%)]"></div>
      </div>
